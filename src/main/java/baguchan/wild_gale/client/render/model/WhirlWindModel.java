...
public class WhirlWindModel<T extends WhirlWind> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = whirl_wind.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 25).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(27, 8).addBox(-5.0F, -1.0F, -4.25F, 10.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 7).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -30.0F, 0.0F));

		PartDefinition body = whirl_wind.addOrReplaceChild("body", CubeListBuilder.create().texOffs(56, 0).addBox(-3.0F, -6.0F, -1.0F, 4.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, -18.0F, -1.0F));

		PartDefinition rods = body.addOrReplaceChild("rods", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition rod4_r1 = rods.addOrReplaceChild("rod4_r1", CubeListBuilder.create().texOffs(30, 39).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 2.0F, 1.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition rod3_r1 = rods.addOrReplaceChild("rod3_r1", CubeListBuilder.create().texOffs(30, 39).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, 2.0F, 1.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition rod2_r1 = rods.addOrReplaceChild("rod2_r1", CubeListBuilder.create().texOffs(30, 39).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, 9.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition rod1_r1 = rods.addOrReplaceChild("rod1_r1", CubeListBuilder.create().texOffs(30, 39).addBox(-1.0F, -6.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, -7.0F, 0.2618F, 0.0F, 0.0F));
