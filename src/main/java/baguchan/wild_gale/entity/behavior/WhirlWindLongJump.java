package baguchan.wild_gale.entity.behavior;
...
public class WhirlWindLongJump extends Behavior<Breeze> {
    public static final JumpExplosionDamageCalculator EXPLOSION_DAMAGE_CALCULATOR = new JumpExplosionDamageCalculator();
    ...
    private static final int INHALING_DURATION_TICKS = Math.round(30.0F);
    ...
    private void explode(ServerLevel serverLevel, Breeze breeze) {
        serverLevel
                .explode(
                        breeze,
                        null,
    ...
    public static final class JumpExplosionDamageCalculator extends ExplosionDamageCalculator {
        @Override
        public boolean shouldDamageEntity(Explosion p_314513_, Entity p_314456_) {
            return !(p_314456_ instanceof Breeze) && p_314456_.isAttackable();
        }
